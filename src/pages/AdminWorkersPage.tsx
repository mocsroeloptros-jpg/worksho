    ...
    <Layout>
      <div className="py-10">
        <div className="flex items-center mb-6">
          ...
          <h2 className="text-3xl font-semibold">Manage Workers</h2>
        </div>
        <p className="text-lg text-muted-foreground mb-8">
          This page will allow administrators to view, add, edit, and remove worker accounts.
        </p>

        <div className="bg-card p-6 rounded-lg shadow-sm border min-h-[200px] flex items-center justify-center text-muted-foreground">
          <p>Worker management features will be displayed here.</p>
        </div>
      </div>
    </Layout>
  );
